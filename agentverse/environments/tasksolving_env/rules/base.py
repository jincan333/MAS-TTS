...
from agentverse.environments.tasksolving_env.rules.ceo import BaseCEO, ceo_registry
from agentverse.environments import BaseRule

if TYPE_CHECKING:
    from agentverse.message import SolverMessage, ExecutorMessage, CEOMessage
...
class TasksolvingRule(BaseRule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        ceo = build_components(ceo_config, ceo_registry)
    ...
    async def resource_distribute(
        ...
        resources = await self.ceo.astep(
            agent=agents[AGENT_TYPES.CEO],
